# VibePlay
Real-time multiplayer party games web app — currently 5x5 bingo (first to 5 lines wins, last caller wins ties). Rooms, random/manual boards, turn-based number elimination, WebRTC voice chat. More games coming soon!
